...
export default function Contact() {
  ...
  return (
    <>
      {/* --- SEO --- */}
      <Helmet>
        <title>Contact | Eagle’s Vision Diagnostics Centre</title>
        <meta
          name="description"
          content="Get in touch with Eagle’s Vision Diagnostics Centre in Ravet, Pune. Contact us for Digital X-Ray, Portable X-Ray, Pathology Lab, Home Sample Collection and more."
        />
        <meta
          name="keywords"
          content="Contact Diagnostic Centre Ravet, Eagle’s Vision Diagnostics Contact, Lab Contact Pune, X-Ray Contact, Pathology Lab Contact, Home Collection Contact"
        />
      </Helmet>
